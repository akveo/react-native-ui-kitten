...
- [Start a new App](/docs/guides/getting-started#new-apps) with a single command from a terminal.
- [Install into existing App](/docs/guides/getting-started#manual-installation). Already run some code? No problem.
