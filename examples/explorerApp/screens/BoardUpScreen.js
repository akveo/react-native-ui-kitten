...
export class BoardUpScreen extends Component {
        ...
        <RkBoardUpView style={[RkStyle.grey300Bg]}>
          ...
          <View
            ...
            <RkTextInput style={{height: 16}}
                         placeholder='Message...'
                         placeholderColor={RkConfig.current.colors.grey300}
                         rkType='bordered'
  ...
  _renderHeader() {
    return (
      <View style={{padding: 10}}>
        <Text style={{textAlign: 'center', color: RkConfig.current.colors.grey500}}>RkBoardUpView provides you...</Text>
      </View>
    )
  }
  ...
  _renderRow(message) {
    let containerStyle = {
      backgroundColor: RkConfig.current.colors.blue500,
      alignSelf: 'flex-end',
      marginLeft: 50,
      marginRight: 10,
    };
