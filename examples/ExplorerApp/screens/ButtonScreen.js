    ...
    return (
      <ScrollView
        ...
        <View style={UtilStyles.section}>
          ...
          <View style={[UtilStyles.rowContainer]}>
            <View style={UtilStyles.exampleView}>
              <RkButton type='basic' size='medium' style={RkStyle.blueBg}
                        textStyle={RkStyle.whiteText}>Primary</RkButton>
              <RkButton type='basic' size='medium' style={[UtilStyles.spaceV, RkStyle.darkYellowBg]}
                        textStyle={RkStyle.whiteText}>Warning</RkButton>
              <RkButton type='basic' size='medium' style={RkStyle.redBg} textStyle={RkStyle.whiteText}>Danger</RkButton>
            </View>
            <View style={[UtilStyles.description]}>
              <Text>Easy to customize colors using
                <Text style={RkStyle.deepOrangeText}> style </Text>
                props for button container styles such as
                <Text style={RkStyle.deepOrangeText}> backgroundColor </Text>
                and
                <Text style={RkStyle.deepOrangeText}> textStyle </Text>
          ...
          <View style={UtilStyles.rowContainer}>
            ...
            <View style={[UtilStyles.description]}>
              <Text>With button props
                <Text style={RkStyle.deepOrangeText}> type </Text>
        ...
        <View style={UtilStyles.section}>
          ...
          <View style={[UtilStyles.description, UtilStyles.row, {paddingLeft: 0, marginTop: 10}]}>
            <Text>
              <Text style={RkStyle.deepOrangeText}>size </Text>
        ...
        <View style={UtilStyles.section}>
          ...
          <View style={UtilStyles.rowContainer}>
            <View style={[UtilStyles.exampleView, {alignItems: 'flex-start'}]}>
              <RkButton type='basic' size='medium' style={RkStyle.blueBg} textStyle={RkStyle.whiteText}
                        icon="diamond" iconStyle={RkStyle.whiteText}>shine</RkButton>
              <RkButton type='outline' size='medium' style={[RkStyle.deepOrangeBorder, UtilStyles.spaceV]}
                        textStyle={RkStyle.deepOrangeText}
                        icon="git" iconStyle={RkStyle.deepOrangeText}>smart</RkButton>
              <RkButton type='basic' size='small' type='outline'
                        iconStyle={[RkStyle.blueText, {fontWeight: '100', fontSize: 10, alignSelf: 'flex-start', marginRight:2}]}
                        icon="plus">Add</RkButton>
            </View>
            <View style={[UtilStyles.description]}>
              <Text>For icons used react-native-vector-icons. Add
                <Text style={RkStyle.deepOrangeText}> icon </Text>
                props with icon name.
                Style icon with
                <Text style={RkStyle.deepOrangeText}> iconStyle </Text>
                props.
                Chose icon family with
                <Text style={RkStyle.deepOrangeText}> iconFamily </Text>
                props.</Text>
            </View>
          </View>
        </View>
        <View style={UtilStyles.section}>
          ...
          <View style={UtilStyles.rowContainer}>
            <View style={[UtilStyles.row, {alignItems: 'center'}]}>
              ...
              <RkButton type='outline' size='medium' style={[RkStyle.deepOrangeBorder, UtilStyles.spaceH]}
                        textStyle={RkStyle.deepOrangeText}
                        icon="git" iconStyle={RkStyle.deepOrangeText}/>
              <RkButton type='basic' style={{borderRadius: 25, paddingVertical: 5, paddingHorizontal: 7}} size='small'
                        type='outline' iconStyle={[RkStyle.blueText, {fontWeight: '100', fontSize: 14}]}
                        icon="plus"/>
            </View>
          </View>
          <View style={[UtilStyles.description, UtilStyles.row, {paddingLeft: 0, marginTop: 10}]}>
        ...
        <View style={UtilStyles.section}>
          ...
          <View style={UtilStyles.rowContainer}>
            <View style={UtilStyles.exampleView}>
              <RkButton type='basic' size='medium' onPress={() => {Alert.alert('click')}} style={RkStyle.redBg} textStyle={RkStyle.whiteText}>Push me!</RkButton>
            </View>
            <View style={UtilStyles.description}>
              <View style={[{alignItems: 'flex-start'}]}>
