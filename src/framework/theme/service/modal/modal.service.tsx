 ...
 * @method {(element: React.ReactElement<ModalComponentCloseProps>,
             closeOnBackDrop: boolean = false) => string} show - Takes component,
...
class ModalServiceType {
  ...
  /**
   * Opens custom dialog window
   * @param {React.ReactElement<ModalComponentCloseProps>} element
  ...
  /**
   * Closes custom dialog window by id
