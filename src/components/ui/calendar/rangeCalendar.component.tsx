 ...
 * Called with a date for this cell and styles provided by Eva.
 *
 * @property {(D, CalendarViewMode) => void} onVisibleDateChange - Called when navigating to the previous or
 * next month / year. viewMode returns string with current calendar view ("YEAR", "MONTH", "DATE").
 *
