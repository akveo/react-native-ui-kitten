 ...
 *
 * @property {boolean} getShouldUseTopInsets - returns `true` if StatusBar additional offset
 * is not enabled, returns `false` if StatusBar additional offset is enabled.
 *
